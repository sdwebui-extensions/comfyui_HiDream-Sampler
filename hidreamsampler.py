...
def load_models(model_type, use_uncensored_llm=False):
    ...
    if not os.path.exists(os.path.join(folder_paths.models_dir, model_path)) and os.path.exists(os.path.join(folder_paths.cache_dir, model_path)):
        model_path = os.path.join(folder_paths.cache_dir, model_path)
